...
class Generator implements ISGraphGenerator {
       ...
       override generate(Statechart model, GeneratorEntry entry, IFileSystemAccess fsa) {
           ...
           function getIntoSatellitesOrbit{
           		   ...
           		   FUNCTION DeployThreeSatellites {
           		       ...
           		       UNTIL satsDeployed = 3 {
           		           ...
           		           WAIT UNTIL SHIP:OBT:TIMEUNTILPERIAPSIS < DeploymentOffset.
           ...
           until ship:status = "LANDED" {
               local landingAltitudeToGround is distanceToGround() - 70.
               ...
               if not nearlyLanded {
                   ...
                   if landingAltitudeToGround < 150 and landingVerticalSpeed < 10 {
                       ...
                       set landingThrustLevel to 0.0. // Idle until burn needed
                   }
               } 
               else {
                   ...
                   if distanceToGround() < 10 {
                       ...
                       set landingThrustLevel to 0.01.
                   } else if landingVerticalSpeed > 2 {
           			print "landingVerticalSpeed > 2" at (0, 7).
                       set landingThrustLevel to 0.1. // Apply gentle thrust to slow descent
                   } else {
           			print "else" at (0, 7).
                       set landingThrustLevel to 0.0. // Maintain low descent speed
                   }
               }
